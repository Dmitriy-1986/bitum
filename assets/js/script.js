...
const bitumData = {
    ...
    'musicList': [
        ...
        {'trackName': 'Каждый прожитый день', 'trackLink': 'https://bitum.pp.ua/assets/music/kazhdyj-prozhityj-den.mp3'},
        {'trackName': 'Ночной город', 'trackLink': 'https://bitum.pp.ua/assets/music/nochnoj-gorod.mp3'},
        {'trackName': 'О чем не скажешь', 'trackLink': 'https://bitum.pp.ua/assets/music/o-chem-ne-skazhesh.mp3'},
        {'trackName': 'Ошибки', 'trackLink': 'https://bitum.pp.ua/assets/music/oshibki.mp3'},
        {'trackName': 'Отдельным особям', 'trackLink': 'https://bitum.pp.ua/assets/music/otdelnym-osobyam.mp3'},
        {'trackName': 'Палата Нумер п\'ять', 'trackLink': 'https://bitum.pp.ua/assets/music/palata-numer-pyat.mp3'},
        {'trackName': 'По улицам где нет добра', 'trackLink': 'https://bitum.pp.ua/assets/music/po-ulicam-gde-net-dobra.mp3'},
        {'trackName': 'Попробуй все', 'trackLink': 'https://bitum.pp.ua/assets/music/poprobuj-vsyo.mp3'},
        {'trackName': 'Рикошет', 'trackLink': 'https://bitum.pp.ua/assets/music/rikoshet.mp3'},
        {'trackName': 'Спокойная ночь', 'trackLink': 'https://bitum.pp.ua/assets/music/spokojnaya-noch.mp3'},
        {'trackName': 'Тряпка', 'trackLink': 'https://bitum.pp.ua/assets/music/tryapka.mp3'},
        {'trackName': 'Утекла', 'trackLink': 'https://bitum.pp.ua/assets/music/utekla.mp3'},
    ],
    'contacts': {
         'city': 'Олександрія',
